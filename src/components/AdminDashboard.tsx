...
import { 
  ...
  ArrowRight, CheckCircle2, Clock, Sparkles, Send, Heart, ShoppingBag, Bell
} from 'lucide-react';
...
type AdminTab = 'overview' | 'products' | 'stock-requests' | 'orders' | 'stock-ledger' | 'create-post' | 'schedule' | 'settings';
