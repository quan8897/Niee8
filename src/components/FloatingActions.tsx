  ...
  return (
    <div className="fixed bottom-24 sm:bottom-8 right-4 sm:right-8 z-[90] flex flex-col gap-3 sm:gap-4">
      ...
      <motion.a
        ...
        aria-label="Zalo"
      >
        <svg viewBox="0 0 24 24" className="w-6 h-6 sm:w-8 sm:h-8 fill-[#0068FF]">
          <path d="M12 2C6.48 2 2 5.58 2 10c0 2.49 1.4 4.67 3.58 6.07l-.58 2.22c-.08.31.21.57.49.43l2.64-1.28c.6.18 1.23.28 1.87.28 5.52 0 10-3.58 10-8S17.52 2 12 2zm4.64 10.35l-3.24-3.24c-.2-.2-.51-.2-.71 0l-3.24 3.24c-.31.3-.41.75-.26 1.15.15.4.55.65 1.01.65h6.44c.46 0 .86-.25 1.01-.65.15-.4.05-.85-.26-1.15z" />
        </svg>
